$(function(){
  ...
  $("#nav").load("/old-website/v2/data/nav.html")
  $("#footer").load("/old-website/v2/data/footer.html")
  $("body").append("<div id=\"require\">")
  $("#require").load("/old-website/v2/data/require.html",function(){$("head")[0].innerHTML+=$("#require2").html(),$("#require")[0].outerHTML=""})
